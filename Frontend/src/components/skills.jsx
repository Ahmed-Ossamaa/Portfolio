...
const SkillsSection = () => {
    const skills = {
        ...
        frontend: ["HTML5", "CSS3", "React", "Redux Toolkit","Angular","Material-UI", "Bootstrap", "Tailwind", "Chart.js"],
        backend: ["Node.js", "Express.js", "RESTful APIs", "JWT", "MongoDB", "Mongoose","NextJS (Fullstack)"],
